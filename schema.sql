...
CREATE TABLE ShiftTemplates (
    ShiftTemplateID INT PRIMARY KEY AUTO_INCREMENT,
    ...
    CreatedAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UpdatedAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UNIQUE KEY uk_shift_name_code (ShiftName, ShiftCode)
);
...
CREATE TABLE RoleShiftTimings (
    RoleShiftTimingID INT PRIMARY KEY AUTO_INCREMENT,
    RoleID INT NOT NULL,
    ...
    CreatedAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UpdatedAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    UNIQUE KEY uk_role_shift (RoleID, ShiftTemplateID),
